...
export const partInfoContent: InfobarContent = {
    title: "Part Management",
    sections: [
        {
            title: "Overview",
            description:
                "The Parts module is used to create and manage all part numbers used throughout the organization. Each part is generated using a combination of Part Type, System Group, Function, Import Type, Supplier, Variant, and Version masters.",
            links: [
                {
                    title: "Part Management Guide",
                    url: "#",
                },
            ],
        },
        {
            ...
            description:
                "Click the 'Create Part' button to add a new part. Select the required master data values and enter the part name and description. The system automatically generates a unique part number based on the selected configuration.",
            links: [
                {
                    title: "Part Creation Guide",
                    url: "#",
                },
            ],
        },
        {
            title: "Part Number Structure",
            description:
                "Part numbers are automatically generated using configured master codes including Part Type, System Group, Function, Import Type, Supplier, Variant, and Version. This ensures consistency across the organization.",
            links: [
                {
                    title: "Part Numbering Standard",
                    url: "#",
                },
            ],
        },
        {
            title: "Editing Parts",
            description:
                "Existing parts can be modified whenever business requirements change. Users can update descriptions, suppliers, variants, versions, and other related information while maintaining traceability.",
            links: [
                {
                    title: "Part Update Process",
                    url: "#",
                },
            ],
        },
        {
            title: "Part Fields",
            description:
                "Each part contains Part Number, Part Name, Description, Part Type, System Group, Function, Import Type, Supplier, Variant, Version, and Status information.",
            links: [
                {
                    title: "Part Fields Documentation",
                    url: "#",
                },
            ],
        },
        {
            ...
            description:
                "Before creating a part, all required masters such as Part Types, System Groups, Functions, Suppliers, Variants, and Versions must be configured in the Masters section.",
            links: [
                {
                    title: "Master Configuration Guide",
                    url: "#",
                },
            ],
        },
